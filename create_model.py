...
def generate_model(img_size):
    ...
    c1 = Conv2D(8, kernel_size=(3, 3), activation='relu', padding='same')(d1)
    d2 = UpSampling2D(size=(2, 2))(c1)
    c2 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d2)
    d3 = UpSampling2D(size=(2, 2))(c2)
    c3 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d3)
    d4 = UpSampling2D(size=(2, 2))(c3)
    c4 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d4)
...
# KERAS-Sample Structure Approach:
    ...
    # base = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(encoder.layers[-1].output)
    # t1 = Conv2DTranspose(16, (3, 3), activation="relu", padding="same")(base)
    # act11 = Activation("relu")(t1)
    # b12 = BatchNormalization()(act11)
    # dUp1 = UpSampling2D(size=(2, 2))(b12)
    # d1 = UpSampling2D(size=(2, 2))(b12)
    # c1 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d1)
    # plus1 = add([c1,dUp1])
    # act12 = Activation("relu")(plus1)
    # b12 = BatchNormalization()(act12)
    # drop1 = Dropout(0.3)(b12)

    # t2 = Conv2DTranspose(16,(3, 3),activation="relu", padding="same")(drop1)
    # act21 = Activation("relu")(t2)
    # b22 = BatchNormalization()(act21)
    # dUp2 = UpSampling2D(size=(2, 2))(b22)
    # d2 = UpSampling2D(size=(2, 2))(b22)
    # c2 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d2)
    # plus2 = add([c2,dUp2])
    # act22 = Activation("relu")(plus2)
    # b22 = BatchNormalization()(act22)
    # drop2 = Dropout(0.3)(b22)

    # t3 = Conv2DTranspose(16, (3, 3), activation="relu", padding="same")(drop2)
    # act31 = Activation("relu")(t3)
    # b32 = BatchNormalization()(act31)
    # dUp3 = UpSampling2D(size=(2, 2))(b32)
    # d3 = UpSampling2D(size=(2, 2))(b32)
    # c3 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d3)
    # plus3 = add([c3,dUp3])
    # act32 = Activation("relu")(plus3)
    # b32 = BatchNormalization()(act32)
    # drop3 = Dropout(0.3)(b32)
   
    # t4 = Conv2DTranspose(16, (3, 3), activation="relu", padding="same")(drop3)
    # act41 = Activation("relu")(t4)
    # b42 = BatchNormalization()(act41)
    # dUp4 = UpSampling2D(size=(2, 2))(b42)
    # d4 = UpSampling2D(size=(2, 2))(b42)
    # c4 = Conv2D(16, kernel_size=(3, 3), activation='relu', padding='same')(d4)
    # plus4 = add([c4,dUp4])
    # act42 = Activation("relu")(plus4)
