...
def create_segnet(input_shape,
    ...
    pool_2, mask_2 = MaxPoolingWithIndices2D(pool_size=(2, 2))(conv_2)

    conv_3 = Convolution2D(2 * num_filters, (3, 3), padding="same", kernel_initializer='he_normal')(pool_2)
    conv_3 = BatchNormalization()(conv_3)
    conv_3 = Activation("relu")(conv_3)

    pool_3, mask_3 = MaxPoolingWithIndices2D(pool_size=(2, 2))(conv_3)
    ...
    unpool_3 = MaxUnpoolingWithIndices2D(size=(2, 2))([conv_6, mask_2])

    conv_7 = Convolution2D(num_filters, (3, 3), padding="same", kernel_initializer='he_normal')(unpool_3)
    conv_7 = BatchNormalization()(conv_7)
    conv_7 = Activation("relu")(conv_7)

    unpool_4 = MaxUnpoolingWithIndices2D(size=(2, 2))([conv_7, mask_1])
